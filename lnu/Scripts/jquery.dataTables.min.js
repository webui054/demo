...
(function (Ea, P, k) {
    var O = function (h) {
        ...
        o.defaults = {
            ...
            oLanguage: {
                oAria: {
                    sSortAscending: ": активувати для сортування стовпці по зростанню",
                    sSortDescending: ": активувати для сортування стовпця спаданням"
                },
                oPaginate: {sFirst: "Першя", sLast: "Остання", sNext: "Наступна", sPrevious: "Попередня"},
                sEmptyTable: "Дані відсутні в таблиці",
                sInfo: "Відображені _START_ - _END_ з _TOTAL_ записів",
                sInfoEmpty: "Відображені 0 - 0 з 0 записів",
                sInfoFiltered: "(filtered from _MAX_ total записів)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                ...
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "Не знайдено жодного запису"
            },
            oSearch: h.extend({},
                o.models.oSearch),
            sAjaxDataProp: "data",
